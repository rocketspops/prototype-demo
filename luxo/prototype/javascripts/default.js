$(function() {
  ...
  $('.overlay__row-wrapper').delegate('.ad_server_select', 'focus', function(e) {
      $(this).autocomplete({
          source:[ "MediaMind", "DART Primary", "DART Secondary", 
  ...
  $('.ad-server-button').click(function() {
    $(".overlay__row-wrapper ul").append('<li><img src="images/ad_server_mgmt/Blank_Row.png" alt="" /><input class="ad_server_select" type="text" /><a href="#"></a></li>');
    return false;
  });
